            ...
            <div>
              ...
              <div className="mt-2">
                <input
                  ...
                  autoComplete="email"
                  required
                  className="block w-full rounded-md border-0 py-1.5 text-gray-300 shadow-sm ring-1 ring-inset bg-[#1d2432] placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                />
              </div>
            </div>
